...
window.require.define({"lib/demo": function(exports, require, module) {
  module.exports = {
    demo: function ( ) {
      ...
      function flightList(div) {
        ...
        div.each(function() {
          ...
          var flight = date.order().selectAll(".flight")
              .data(function(d) {
                // Sort values for each group, since they aren't guaranteed to be
                // in order within each group.
                return d.values.sort(function(a, b) { return b.date - a.date; });
...
window.require.define({"lib/square_demo": function(exports, require, module) {
